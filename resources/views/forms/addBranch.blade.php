<form class="form-horizontal" method="POST" action="{{ route('branch.store') }}" >
    ...
    <div class="form-group{{ $errors->has('code') ? ' has-error' : '' }}">
        ...
        <div class="col-md-12">
            <input type="text" class="form-control" name="code" value="{{ old('code') }}" maxlength="255" required autofocus>
    ...
    <div class="form-group{{ $errors->has('desc') ? ' has-error' : '' }}">
        ...
        <div class="col-md-12">
            <textarea type="text" class="form-control" name="desc" maxlength="255" autofocus>{{ old('desc') }}</textarea>
