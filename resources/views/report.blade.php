        ...
        <div class="card card-report">
            <div class="card-body">
                <form class="form-horizontal" method="POST" action="" >
                    ...
                    <div class="form-group{{ $errors->has('reportType') ? ' has-error' : '' }} row">
                        <label for="reportType" class="col-md-4 col-control-label">Report Type:</label>

                        <div class="col-md-6">
                            <select class="btn btn-dropdown dropdown-toggle form-control" name="reportType">
...
<div class="row row-report">   
    <div class="col-sm-12"> 
        <table border="0" cellspacing="5" cellpadding="5">
            <tbody>
                <tr class="form-group">
                    <td class="control-label">Age:</td>
                    <td><input class="form-control form-control-sm" type="text" id="min" name="min"></td>
                </tr>
                <tr>
                    <td class="control-label">Maximum age:</td>
                    <td><input class="form-control form-control-sm" type="text" id="max" name="max"></td>
                </tr>
            </tbody>
        </table>
        <table id="dataTable" class="table table-bordered dataTable" cellspacing="0" width="100%">
            <thead>
                <tr>
                    <th class="sorting" tabindex="0", aria-controls="example" rowspan="1" colspan="1">Name</th>
                    <th class="sorting" tabindex="0", aria-controls="example" rowspan="1" colspan="1">Position</th>
                    <th class="sorting" tabindex="0", aria-controls="example" rowspan="1" colspan="1">Office</th>
                    <th class="sorting" tabindex="0", aria-controls="example" rowspan="1" colspan="1">Age</th>
